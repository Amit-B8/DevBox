      ...
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-5 text-sm text-amber-100 leading-relaxed">
            This calculator is for educational and research-oriented estimation only. It is not a validated clinical planning tool and should not replace professional ophthalmic judgment.
          </div>
        </div>
      </div>
    </main>
